        ...
        <div class="w-full max-w-md bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden p-10 mx-auto my-8 
            ...
            <div class="w-full md:max-w-md 2xl:max-w-2xl">
                ...
                <form wire:submit.prevent="register">
                    ...
                    <div class="mb-6">
                        {{-- Añadir estilos a este h2 --}}
                        <h2>Para registrarse como vendor seleccione los mercadillos en los que quiera participar</h2>
                        ...
                        <div class="space-y-2">
                            @foreach($markets as $market)
                                <label class="flex items-center">
                                    ...
                                    >
                                    <span class="ml-2 text-sm text-gray-700">{{ $market->name }}</span>
                                </label>
                            @endforeach
                        </div>
                    </div>
