<div class="min-h-screen bg-primary-pastel font-atkinson p-16 ">
    ...
    <div class="bg-status-white rounded-none md:rounded-lg shadow-sm p-5 pb-8">
        ...
        <section class="mb-10">
            ...
            <div class="mb-6">
                <label for="nombre_producto" class="block font-dm-serif font-bold mb-2">
                    Nombre del producto *
                </label>
                <input type="text" id="nombre_producto" placeholder="Tomate de ensalada"
                    class="w-full bg-accent-lightred border-none rounded py-3 px-4 text-status-dark focus:ring-2 focus:ring-primary-light outline-none placeholder:font-atkinson placeholder:text-accent-grey">
            </div>
            ...
            <div class="mb-6">
                ...
                <div class="flex flex-col space-y-3">
                    <label class="flex items-center space-x-3 cursor-pointer">
                        <input type="radio" name="unidad" class="w-5 h-5 text-primary border-none bg-accent-lightgrey focus:ring-primary-light">
            ...
            <div class="mb-6">
                ...
                <select id="categoria" class="w-full bg-accent-lightred border-none rounded py-3 px-4 text-accent-grey appearance-none focus:ring-2 focus:ring-primary-light">
            ...
            <div class="mb-6">
                ...
                <button type="button" class="w-full flex items-center bg-accent-lightred rounded py-3 px-4 text-accent-grey">
        ...
        <section>
            ...
            <div class="bg-accent-lightgreen rounded-lg p-5 mb-4">
                ...
                <select id="puesto_seleccion" class="w-full bg-status-white border-none rounded py-3 px-4 text-accent-grey appearance-none focus:ring-2 focus:ring-primary mb-5 shadow-sm">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" id="cantidad" placeholder="Ej: 20"
                            class="w-full bg-status-white border-none rounded py-3 px-4 text-status-dark placeholder:text-accent-grey focus:ring-2 focus:ring-primary outline-none shadow-sm mb-1">
                        <span class="text-primary text-lg font-bold">Unidades en este puesto</span>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="precio" placeholder="Ej: 3.50€"
                            class="w-full bg-status-white border-none rounded py-3 px-4 text-status-dark placeholder:text-accent-grey focus:ring-2 focus:ring-primary outline-none shadow-sm mb-1">
                        <span class="text-primary text-lg font-bold">Precio en este puesto</span>
                    </div>
                </div>
            </div>

            <button type="button" class="w-full flex items-center justify-center py-3 border border-dashed border-primary rounded text-status-dark text-sm font-bold hover:bg-gray-50 transition-colors">
